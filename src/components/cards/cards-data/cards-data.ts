const countries = [

  {
    ...
    nameKa: "იაპონია",
    nameEn: "Japan",
    titleKa: "პარკები იაპონიაში, სადაც მთელი ოჯახით დაისვენებთ",
    titleEn: "Find Fun for the Whole Family at Japan’s Theme Parks",
  ...
  },
  {
    ...
    nameKa: "ჩინეთი",
    nameEn: "China",
    titleKa: "ორ კვირიანი დასვენება ჩინეთში",
    titleEn: "The Perfect Two Week Itinerary in China",
    population: 12220000,
    capitalKa: "ბეიჯინგი",
    capitalEn: "Beijing",
    descriptionKa:
  ...
  },
  {
    ...
    nameKa: "კორეა",
    nameEn: "Korea",
    titleKa: "ალუბლების ყვავილობა სეულში",
    titleEn: "Cherry blossom in Seoul",
    population: 51000000,
    capitalKa: "სეული",
    capitalEn: "Seoul",
    descriptionKa:
